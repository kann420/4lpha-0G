  ...
  return (
    <section className="soft-panel rounded-[24px] p-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h2 className="text-base font-semibold text-foreground">Policy limits</h2>
          <p className="mt-1 text-sm leading-6 text-muted">Vault-enforced demo guardrails.</p>
        </div>
        <span className="rounded-full border border-green/20 bg-green/10 px-2.5 py-1 text-xs font-semibold text-green">
          deny-first
        </span>
      </div>
      <div className="mt-4">
      ...
      <label className="mt-4 block">
        <div className="mb-2 flex items-center justify-between gap-3">
          ...
          <span className="font-mono text-sm text-primary">{slippageBps} bps</span>
        </div>
        <input
          type="range"
          min="25"
